...
try:
    opts, args = getopt.getopt(sys.argv[1:],"i:t:d:",["idir=","num-eq-classes=","TCC-file=","TCCD-file="])
except getopt.GetoptError:
    print ("getopterrror")
    print ('usage is : \n python get_UMI_matices.py -i input_t3i_dir  -t path-to-output-TCC-UMI-file -d path-to-output-TCC-UMI-dist-file')
    sys.exit(1)
