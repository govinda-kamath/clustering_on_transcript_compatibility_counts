...
sampling_rates=['1','0.1','0.05','0.01','0.05','0.01']
read_dir_to_pass=read_dir_base+sampling_suffix[0]+"/"
...
for index in range(6):
    ...
    os.system('python get_pseudoalignments.py -i ./reads_and_UMI_subsample100/ -o '+TCC_dir+' -k '+kallipso_path+ ' -t '+ index_path +' -n '+ str(num_proc))
